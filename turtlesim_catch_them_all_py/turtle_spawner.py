...
class TurtleSpawner(Node):
    def __init__(self):
        ...
        self.declare_parameter("turtle_name_prefix","NinjaTurtle")
        ...
        self.catch_turtle_service_ = self.create_service(
            CatchTurtle,"catch_turtle",self.callback_catch_turtle_server)
    ...
    def callback_catch_turtle_server(self,request,response):
